...
- **Modo presentación** (`informe/fase1/presentacion-fase1.html`): deck de **56 láminas** que renderiza visualmente cada sección (s7 tiene 7 láminas por sus subpuntos). Botón "▶ Presentar" junto a cada h2 (decoración JS, solo en las 11 secciones que tienen láminas), FAB "▶ Presentación", overlay fullscreen, ←/→, menú de secciones, hash routing (`#s7`), Esc vuelve a la lectura. Cada lámina es un `<section class="slide" data-sec="sN">` autocontenido — añadir/editar láminas = editar ese archivo. ⚠️ Los rótulos del menú (`SEC_NAMES`) siguen la numeración ANTERIOR a la reestructuración de jul-2026 (s10 = "Arquitectura de IA"): conciliar con el informe antes de presentar.
