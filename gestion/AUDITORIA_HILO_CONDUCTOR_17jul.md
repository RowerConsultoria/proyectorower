...
8.3-8.4 **no citan ni una vez la sección 5** (verificado l.1637-1643). s5 diagnostica que no hay capacidad instalada de formación; s8 describe dos ejes de formación en curso; el informe nunca dice que los ejes son vehículos del proyecto sin dueño organizacional permanente, ni ancla la certificación Maia/Claude al Diccionario de Competencias con IA (5.2/5.4) que las haría evaluables por perfil. Desduplicar además la advertencia de la Encuesta Baseline (l.989 y l.1639).
